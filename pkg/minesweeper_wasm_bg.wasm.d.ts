...
export function minesweeper_isLost(a: number): number;
export function minesweeper_isFinished(a: number): number;
export function minesweeper_getIcon(a: number, b: number, c: number, d: number): void;
export function minesweeper_isBomb(a: number, b: number, c: number): number;
export function minesweeper_clicked_bomb(a: number, b: number, c: number): void;
